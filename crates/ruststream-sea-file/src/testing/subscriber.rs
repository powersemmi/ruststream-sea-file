//! [`FileTestSubscriber`] and [`FileTestMessage`].
...
impl std::fmt::Debug for FileTestSubscriber {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("FileTestSubscriber").finish_non_exhaustive()
    }
}
...
/// Message handed to handlers from an [`FileTestSubscriber`].
///
...
impl std::fmt::Debug for FileTestMessage {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("FileTestMessage").finish_non_exhaustive()
    }
}
